...
// //         // console.log('Response:', result.rows); // Add this line
// //         // res.json(result.rows);
// //       } catch (error) {
// //         console.error(error);
...
// //     const { selectedOption } = req.body;
// //     if (selectedOption === '1') {
// //       console.log('Calculating sum for option 1');
// //       const result = await pool.query('SELECT SUM(value) as sum FROM values_measurement');
